window.TRIP_DATA = {
  ...
  activityBoard: {
    elsie: [
      ...
      { title: "Twin Lakes and Lake Thompson", type: "Island", detail: "Fire Tower Road runs through the island's interior to Twin Lakes and Lake Thompson, the island's biggest inland lakes.", link: "https://kids.kiddle.co/Bois_Blanc_Island_(Michigan)", lookFor: "Fishing lakes, forest, gravel road", capture: "Photo of the lake through the trees" },
      { title: "Walker's Point ruins", type: "Island", detail: "The ruins of an old U.S. Life-Saving Station, first established around 1891 for maritime rescue work, sit near Walker's Point.", link: "https://grokipedia.com/page/Bois_Blanc_Island_(Michigan)", lookFor: "Old foundations, shoreline, story of what it was for", capture: "Ruins photo with a one-line explainer" },
      { title: "Snake Island / Mud Lake shoreline", type: "Island", detail: "A DNR-managed natural area with cobble Lake Huron beach and dune-and-swale wetlands — home to the rare dwarf lake iris.", link: "https://www.michigan.gov/dnr/places/natural-areas/bois-blanc-island", lookFor: "Cobble beach, marsh, ridges, rare plants (look, don't pick)", capture: "Shoreline photo" },
      { title: "Bois Blanc's forest and wildlife", type: "Nature", detail: "Most of the island is state-owned Mackinaw State Forest. Deer are common, and coyotes, foxes, bald eagles, and even the occasional bobcat live here.", link: "https://www.boisblanctownship.org/downloads/bbiglia_island_showcase_20190629.pdf", lookFor: "Deer, birds of prey, animal tracks", capture: "Wildlife sighting note or photo" }
    ],
    katrina: [
